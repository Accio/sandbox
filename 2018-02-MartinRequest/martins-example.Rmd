...
In this document, I develop a minimal example to explain my ideas about testing a small set of geneset for enrichment of genesets.

## A list of genes with statistics

Suppose we have twelve genes with given log2 fold changes (logFC) between condition one and condition two.
